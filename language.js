  ...
  const translations = {
    en: {
      ...
      gallery: {
        ...
        items: [
          ...
          { nom: 'The depth of the eye', description: 'I wanted to do a very tight close-up on an eye, to really dive into the intensity of a gaze. The idea was to focus on just one part of the face, but to give it my complete attention.\n\nFor this drawing, the bulk of my work focused on the most meticulous details. I spent a lot of time on the texture of the iris, looking for the right reflections and shadows to try and bring as much depth and life to it as possible. Drawing each eyelash also required a great deal of patience: I had to find the right movement and thickness to frame the eye naturally, without making it heavy.\n\nIt is a very close, almost intimate study that invites observation. I hope this frank and direct gaze will catch yours.', details: 'A4 size (21 × 29.7 cm) • 240 gsm Paper • 14 Hours of Work • Original Artwork', price: '€280' },
          { nom: 'The ice cream break', description: 'I was immediately touched by the contrast in this little everyday scene. On one hand, there is the obvious delight of the moment, with this ice cream cone held firmly in his hand, and on the other, that deep, almost solemn gaze that children can sometimes have right in the middle of a snack.\n\nFor this drawing, I had a lot of fun working on the different textures: the thickness and folds of the cardigan, the small details of the patch, and the waffle pattern of the ice cream cone. All these textured elements serve to highlight the softness of his face and frame his somewhat thoughtful expression. The deliberately blurred background keeps all the focus on the directness of his wide eyes.\n\nIt is a little snapshot of life, simple and unadorned. I hope this sweet moment makes you smile and finds a place in your home.', details: 'A3 size (29.7 × 42 cm) • 240 gsm Paper • 9 Hours of Work • Original Artwork', price: 'Private collection' },
          { nom: 'Grace', description: 'For this drawing, I wanted to shake up my habits a bit. My love for horses remains the same, but I chose to express it in a completely different way here, going straight to the essential.\n\nThe idea wasn\'t to seek realism or get lost in meticulous details as I usually do. I preferred to play solely on the boldness of the line and the pure contrast of black on white. With these few simple, strong lines, I tried to capture the movement of its mane, the elegance of its posture, and its proud character. It is a much more minimalist style exercise, but a very liberating one.\n\nIt is a graphic and refined drawing. I hope you enjoy this more modern approach just as much and that it brings a beautiful dynamic to your home.', details: 'A4 size (21 × 29.7 cm) • 240 gsm Paper • 3 Hours of Work • Original Artwork', price: '€90' },
          { nom: 'Brotherly bond', description: 'This double portrait is particularly close to my heart. I wanted to capture the beautiful complicity and boundless energy that unites these two brothers. Through their mischievous smiles and sparkling eyes, I tried to catch that precious brotherly bond, built on shared games and obvious affection.\n\nI invested a lot of effort into the contrast between their two faces and the work on their hair, while creating a beautiful sense of unity thanks to the soft, luminous background that makes their expressions stand out. Although they each have their own distinct features and character, their direct, lively gazes complement each other perfectly.\n\nIt is a drawing filled with affection, created with a lot of tenderness. For this reason, it is not for sale: this artwork has already found its forever home and hangs proudly on the walls of their family home.', details: 'A3 size (29.7 × 42 cm) • 240 gsm Paper • 20 Hours of Work • Original Artwork', price: 'Private collection' },
          { nom: 'Spirit of adventure', description: 'For this new piece, I wanted to explore a different path and let myself be carried away by the magic of watercolor. I set down my usual pencils to play with the transparency of water and the warmth of sepia and burnt sienna pigments.\n\nThe idea was to make this old sailing ship emerge like a distant memory, an almost ghostly apparition floating in the mist. Rather than seeking meticulous realism, I let the brushstrokes freely sketch the volume of the sails and the structure of the hull. The paint lives, spreads, and lets the imagination fill in the blanks. This gives the whole piece a very dreamlike and deeply nostalgic feel.\n\nIt is a more spontaneous and fluid creation, designed as a true invitation to travel. I hope this poetic atmosphere will take you on a beautiful journey to new horizons.', details: 'A3 size (29.7 × 42 cm) • 240 gsm Paper • 18 Hours of Work • Original Artwork', price: 'Sold' },
          { nom: 'Radiant smile', description: 'This portrait captures the essence of a thoughtful and kind personality, where intelligence shines through every feature. The luminous and generous smile is the vibrant heart of the portrait, expressing a confident and authentic gentleness that radiates throughout the entire composition.\n\nParticular attention was given to the gaze and the smile to capture their intensity and liveliness. The tied-back hairstyle highlights the delicacy of the facial features and reinforces the radiant impact of the expression. Delicate contrasts of light and shadow, especially around the features and smile, were carefully developed to create volume and presence. The intentionally discreet background allows the portrait to retain all its intimacy and emotional impact.\n\nThe result of many hours of work and patience, this original artwork seeks above all to preserve the authenticity and sincerity of a fleeting moment.', details: 'A3 size (29.7 × 42 cm) • 240 gsm Paper • 12 Hours of Work • Original Artwork', price: '€230' },
          { nom: 'Intense gaze', description: 'This portrait focuses on the strength of a direct gaze, where pronounced makeup underlines the depth of the expression. The slightly parted mouth brings a touch of softness to this intensity, balancing assured presence with restraint.\n\nParticular attention was given to the eyes and makeup to capture their intensity, with careful blending used to render the texture of the skin and the contrasts of light. The background, suggested by a few blurred reflections, remains intentionally discreet so that the face can take center stage.\n\nThe result of several hours of work, this original artwork seeks to capture the presence of a gaze.', details: 'A3 size (29.7 × 42 cm) • 240 gsm Paper • 11 Hours of Work • Original Artwork', price: '€230' },
          { nom: 'Silent tenderness', description: 'This portrait dwells on a moment of contemplation, with the face inclined and the eyes closed, in an intimate and peaceful atmosphere. The long strands of hair falling freely over the face and shoulders bring movement and lightness to this otherwise still pose, suspended in time.\n\nParticular attention was given to the hair, its textures and its many shades of grey and black, to give it volume and life. The play of light suggested by the bright patches in the background creates a soft, almost diffuse depth that envelops the portrait without ever drawing attention away from the face. The subtly visible grain of the paper adds another layer of texture to the whole.\n\nThe result of many hours of work and patience, this original artwork seeks to capture a moment of calm and inner reflection, both fragile and soothing.', details: 'A3 size (29.7 × 42 cm) • 240 gsm Paper • 11 Hours of Work • Original Artwork', price: '€230' },
      ...
      actions: {
        ...
        howTitle: 'How does the project work?',
        howP1: 'The drawings presented on this site are offered for sale.',
        howP2: 'The proceeds from sales help fund our volunteer days. We organise and take part in these days ourselves, on a personal and voluntary basis.',
        dayTitle: 'A day with the children',
        dayP1: 'Each day is prepared in advance with the organisation hosting us, so that we can best adapt to the children present.',
        dayP2: 'The afternoon generally includes games, drawing, magic, music, balloon sculptures and puppet shows led by two clowns who accompany us.',
        dayP3: 'Snack time follows, adapted to any reported allergies, and then it is time to hand out the gifts.',
        dayP4: 'When the group activities end, we take the time to visit the rooms and give each child a personalised gift, chosen carefully with their age and needs in mind. These more personal moments allow us to talk with the children and their families, share a few words and extend the day in a different way.',
        momentsTitle: 'A few shared moments',
        momentsText: 'A few memories from our days with the children.',
    ...
    fr: {
      ...
      about: {
        ...
        processIntro: 'Chaque portrait commence par une simple esquisse de construction et évolue progressivement par des couches d\'ombrage, et de détails jusqu\'au dessin final.',
      ...
      contact: {
        title: 'Discutons',
        desc: 'Que vous soyez intéressé·e par une création, que vous ayez une commande en tête ou que vous souhaitiez simplement vous renseigner, n\'hésitez pas à m\'écrire.',
      ...
      actions: {
        ...
        howTitle: 'Comment fonctionne le projet ?',
        howP1: 'Les dessins présentés sur ce site sont proposés à la vente.',
        howP2: 'Les bénéfices issus des ventes contribuent au financement de nos journées de bénévolat. Nous organisons et participons nous-mêmes à ces journées, à titre personnel et bénévole.',
        dayTitle: 'Une journée auprès des enfants',
        dayP1: 'Chaque journée est préparée en amont avec la structure qui nous accueille, afin de nous adapter au mieux aux enfants présents.',
        dayP2: 'L\'après-midi est généralement rythmé par des jeux, du dessin, des tours de magie, de la musique, des sculptures sur ballons et des spectacles de marionnettes, proposées par deux clowns qui nous accompagnent.',
        dayP3: 'Vient ensuite le temps du goûter, adapté aux éventuelles allergies signalées, puis celui de la remise des cadeaux.',
        dayP4: 'Lorsque les animations collectives se terminent, nous prenons le temps de passer dans les chambres pour remettre à chaque enfant un cadeau personnalisé, choisi avec attention en tenant compte de son âge et de ses besoins. Ces moments plus personnels nous permettent de prendre le temps d\'échanger avec les enfants et leurs familles, de partager quelques mots et de prolonger autrement cette journée.',
        momentsTitle: 'Quelques moments partagés',
        momentsText: 'Quelques souvenirs de nos journées auprès des enfants.',
        ...
        album3: 'Distribution de repas chauds',
      ...
      process: {
        title: "Processus",
        desc: "Découvrez une sélection de dessins accompagnés des différentes étapes de leur création. Des premiers traits de crayon au dessin terminé, ces images montrent l'évolution de quelques réalisations.",
