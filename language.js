  ...
  const translations = {
    en: {
      ...
      index: {
        ...
        card1Desc: 'A graphite and charcoal portrait, focused on expression, character, and realistic detail.',
        card2Title: 'Child Portrait',
        card2Desc: 'A drawing that captures innocence, warmth, and natural emotion.',
        card3Title: 'Realism Study',
        card3Desc: 'An exploration of texture, contrast, and light through meticulous work in pencil and charcoal.',
    ...
    fr: {
      ...
      index: {
        ...
        card1Desc: 'Un portrait au graphite et au fusain centré sur l\'expression, le caractère et le détail réaliste.',
        ...
        card3Desc: 'Une exploration de la texture, du contraste et de la lumière par un travail minutieux au crayon et au fusain.',
