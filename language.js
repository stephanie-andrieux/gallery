(function () {
  ...
  const translations = {
    en: {
      ...
      about: {
        title: 'About',
        p1: 'I am a passionate artist and illustrator with a love for drawing and visual storytelling. Through my work, I explore different techniques, experiment with styles, and create pieces that reflect my imagination and artistic vision.',
        p2: 'This website showcases my portfolio, ongoing projects, and creative journey. I hope you enjoy discovering my work.',
    ...
    fr: {
      ...
      about: {
        title: 'À propos',
        p1: 'Je suis une artiste et illustratrice passionnée, amoureuse du dessin et de la narration visuelle. À travers mon travail, j\'explore différentes techniques, expérimente des styles et crée des pièces qui reflètent mon imagination et ma vision artistique.',
        p2: 'Ce site présente mon portfolio, mes projets en cours et mon parcours créatif. J\'espère que vous prendrez plaisir à découvrir mon univers.',
